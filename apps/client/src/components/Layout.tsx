...
const nav = [
  ...
  { to: "/dashboard", label: "Activity", icon: CalendarCheck, active: ["/dashboard"] },
...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f5ef] text-porter-ink">
      <header className="sticky top-0 z-40 border-b border-black/[0.06] bg-[#f7f5ef]/94 backdrop-blur-xl">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-50 border-t border-black/10 bg-[#f7f5ef]/94 px-2 pb-2 pt-1 backdrop-blur-xl md:hidden">
            ...
            return (
              <NavLink
                ...
                className={cx(
                  ...
                  isActive ? "bg-[#111411] text-white" : "text-porter-ink/65",
                )}
              >
